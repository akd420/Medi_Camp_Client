...
const ContactUs = () => {
    return (
        <div>
            <div className="relative overflow-hidden">
                <img src="/contactus.jpg" alt="" className="opacity-60 md:h-auto h-[200px]" />
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      <p className="mb-8 lg:mb-16 text-center text-rose text-2xl">Get In Touch With Us.</p>
      <form action="#" className="space-y-8">
          <div>
              <label className="block mb-2 text-sm font-medium text-gray-900">Your email</label>
              <input type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 " placeholder="Enter Your Email Here" required/>
          </div>
          <div>
          ...
          <CustomButton>Send message</CustomButton>
            ...
            <div>
                ...
                <p className="text-center text-xl text-rose mb-5">The Queen's Walk, Bishop's, London SE1 7PB,<br /> United Kingdom.</p>
                <Map position={[51.50355492774545, -0.11936052883487921]} popUp={"MediCamp"}></Map>
            </div>
            </CustomContainer>
        </div>
    );
